...
namespace myos
{
    namespace drivers
    {
        ...
        protected:
            ...
            // sends intialziation codes to the ports
            void WriteRegisters(common::uint8_t* registers);
            // gives the correct offset for the segment we want to use
